...
from typing import Callable, Any, Dict, Awaitable, cast, Optional

from .env import get_3commas_credentials, validate_environment
...
class RateLimiter:
    ...
    def can_make_request(self, endpoint_type: str = "standard") -> bool:
        ...
        self._requests[endpoint_type] = [
            req_time for req_time in self._requests[endpoint_type]
